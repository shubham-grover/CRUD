...
@WebServlet("/add_editservlet1")
public class add_editservlet1 extends HttpServlet {
	 ...
	 protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    protected void doPost(HttpServletRequest request, HttpServletResponse response)   
	    	 ...
	    	 response.setContentType("text/html");  
		        ...
		        out.println("<h1 style='text-align:center;'>Add details of Employee</h1>"); 
		        String sid=request.getParameter("id");  
		        int id=Integer.parseInt(sid);  
		        employee e=newuserdao.getEmployeeById(id);  
		        add_details a=newuserdao.showDetailsById(id) ;
		        out.print("<form action='add_editservlet2?id="+e.getId()+"' method='post'>");  
